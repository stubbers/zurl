...
<?php else : ?>
					<label for="email">Email Address:</label>
					<?php echo $values['email']; ?><input type="hidden" name="token" value="<?php echo csrf::token(); ?>" /><br />
					
					<label for="invite_code">Invite Code:</label>
					<?php echo $invite_code; ?><input type="hidden" name="invite_code" value="<?php echo $invite_code; ?>" /><br />
<?php endif; ?>
